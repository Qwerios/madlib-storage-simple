(function() {
  ...
  (function(factory) {
    if (typeof exports === "object") {
      return module.exports = factory(require("madlib-settings"));
    } else if (typeof define === "function" && define.amd) {
      return define(["madlib-settings"], factory);
    }
  })(function(settings) {
    var databaseName, dbStorage, itemCount, storage, updateItemCount;
